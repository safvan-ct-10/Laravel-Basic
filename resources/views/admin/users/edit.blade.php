                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.users.update') }}" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label>D.O.B</label>
                                    <input type="date" class="form-control" name="dob" required value="{{ $user->dob->format('Y-m-d') }}">
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                            ...
                            <a href="{{ route('admin.users') }}" class="btn btn-secondary text-white btn-fw float-right mr-2">CANCEL</a>
                        </form>
                    </div>
                </div>
            </div>
